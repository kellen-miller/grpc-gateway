...
import (
	...
	"github.com/kellen-miller/grpc-gateway/v2/examples/internal/proto/oneofenum"
	...
	"github.com/kellen-miller/grpc-gateway/v2/examples/internal/proto/sub2"
...
func (s *_ABitOfEverythingServer) Create(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	s.m.Lock()
	defer s.m.Unlock()
...
func (s *_ABitOfEverythingServer) CreateBody(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
...
func (s *_ABitOfEverythingServer) CreateBook(
	ctx context.Context,
	req *examples.CreateBookRequest,
) (*examples.Book, error) {
	return &examples.Book{}, nil
}

func (s *_ABitOfEverythingServer) UpdateBook(
	ctx context.Context,
	req *examples.UpdateBookRequest,
) (*examples.Book, error) {
	return &examples.Book{}, nil
}
...
func (s *_ABitOfEverythingServer) Custom(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	s.m.Lock()
...
func (s *_ABitOfEverythingServer) DoubleColon(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	s.m.Lock()
...
func (s *_ABitOfEverythingServer) GetQuery(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*emptypb.Empty, error) {
	s.m.Lock()
...
func (s *_ABitOfEverythingServer) GetRepeatedQuery(
	ctx context.Context,
	msg *examples.ABitOfEverythingRepeated,
) (*examples.ABitOfEverythingRepeated, error) {
	s.m.Lock()
	defer s.m.Unlock()
...
func (s *_ABitOfEverythingServer) DeepPathEcho(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	s.m.Lock()
...
func (s *_ABitOfEverythingServer) GetMessageWithBody(
	ctx context.Context,
	msg *examples.MessageWithBody,
) (*emptypb.Empty, error) {
...
func (s *_ABitOfEverythingServer) CheckGetQueryParams(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	return msg, nil
...
func (s *_ABitOfEverythingServer) CheckNestedEnumGetQueryParams(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	return msg, nil
...
func (s *_ABitOfEverythingServer) CheckPostQueryParams(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	return msg, nil
...
func (s *_ABitOfEverythingServer) OverwriteRequestContentType(
	ctx context.Context,
	msg *examples.Body,
) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, nil
...
func (s *_ABitOfEverythingServer) CheckExternalPathEnum(
	ctx context.Context,
	msg *pathenum.MessageWithPathEnum,
) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, nil
}

func (s *_ABitOfEverythingServer) CheckExternalNestedPathEnum(
	ctx context.Context,
	msg *pathenum.MessageWithNestedPathEnum,
) (*emptypb.Empty, error) {
	return &emptypb.Empty{}, nil
}

func (s *_ABitOfEverythingServer) CheckStatus(
	ctx context.Context,
	empty *emptypb.Empty,
) (*examples.CheckStatusResponse, error) {
...
func (s *_ABitOfEverythingServer) CustomOptionsRequest(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*emptypb.Empty, error) {
	err := grpc.SendHeader(ctx, metadata.New(map[string]string{
...
func (s *_ABitOfEverythingServer) TraceRequest(
	ctx context.Context,
	msg *examples.ABitOfEverything,
) (*examples.ABitOfEverything, error) {
	return msg, nil
...
func (s *_ABitOfEverythingServer) PostOneofEnum(
	ctx context.Context,
	msg *oneofenum.OneofEnumMessage,
) (*emptypb.Empty, error) {
	return new(emptypb.Empty), nil
}

func (s *_ABitOfEverythingServer) PostRequiredMessageType(
	ctx context.Context,
	req *examples.RequiredMessageTypeRequest,
) (*emptypb.Empty, error) {
	return new(emptypb.Empty), nil
}
