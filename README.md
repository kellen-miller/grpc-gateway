...
<a href="https://github.com/kellen-miller/grpc-gateway/actions/workflows/ci.yml"><img src="https://img.shields.io/github/actions/workflow/status/grpc-ecosystem/grpc-gateway/ci.yml?color=379c9c&label=build&logo=github&logoColor=ffffff&style=flat-square"/></a>
...
import (
	_ "github.com/kellen-miller/grpc-gateway/v2/protoc-gen-grpc-gateway"
	_ "github.com/kellen-miller/grpc-gateway/v2/protoc-gen-openapiv2"
...
```sh
go install \
    github.com/kellen-miller/grpc-gateway/v2/protoc-gen-grpc-gateway \
    github.com/kellen-miller/grpc-gateway/v2/protoc-gen-openapiv2 \
...
```sh
go get -tool github.com/kellen-miller/grpc-gateway/v2/protoc-gen-grpc-gateway
go get -tool github.com/kellen-miller/grpc-gateway/v2/protoc-gen-openapiv2
...
the [GitHub releases page](https://github.com/kellen-miller/grpc-gateway/releases/latest).
...
```shell
slsa-verifier -artifact-path <the-binary> -provenance attestation.intoto.jsonl -source github.com/kellen-miller/grpc-gateway -tag <the-tag>
```
...
```shell
$ go get github.com/kellen-miller/grpc-gateway/v2@v2.16.2
```
...
- [How gRPC error codes map to HTTP status codes in the response](https://github.com/kellen-miller/grpc-gateway/blob/main/runtime/errors.go#L15).
...
See [CONTRIBUTING.md](http://github.com/kellen-miller/grpc-gateway/blob/main/CONTRIBUTING.md).
